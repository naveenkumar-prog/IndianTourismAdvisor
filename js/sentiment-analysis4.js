const HOSTED_URLS = {
    // queryTwitter:  'https:' + '//'+ window.location.hostname + '/js/sentiment/queryTwitter.php?q=',
    queryTwitter:  'https:' + '//' + '/js/sentiment/queryTwitter.php?q=',
...
function twitterSentiment(){
    console.log("twitterSentiment entered")
...
console.log("window.location.hostname:- ",window.location.hostname);
    ...
    console.log("getTwitterHashTagData calling");
    // console.log($("#tag-input").val());
    var entered = $("#tag-input").val()+"tourism";
    // var entered = $("#tag-input").val();

    console.log(entered);
    getTwitterHashTagData(entered, processTwitterData);
}
...
function getTwitterHashTagData(query, callback) {
    // let query1 = query.replace("tourism", "");
    console.log("query1:"+query);
    console.log("urls.queryTwitter: "+urls.queryTwitter);

    $.getJSON( urls.queryTwitter + query, function(result) {
        console.log(result);
        if(result.statuses.length == 0){
            let query1 = query.replace("tourism", "");
        $.getJSON( urls.queryTwitter + query1, function(result) {
        console.log(result);
        ...
        else if(result !== null && result.statuses !== null){
            callback(result.statuses);
        }
